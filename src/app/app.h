...
class App final {
 public:
  ...
  static void SelectAction(int argc, char** argv, FileAction file_action, ShellAction shell_action) {
      if (const auto user_filepath = cl::Cli::GetUserFilesPath(argc, argv);
