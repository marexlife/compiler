...
{
    static const std::string_view path_is_relative_error_message = "Path is relative.";

    static const std::string_view path_is_out_of_argument_range = "Path is out of argument range.";
